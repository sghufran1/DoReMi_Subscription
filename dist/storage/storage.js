...
exports.Subscribed_services = void 0;
...
let dumpToJsonFile = function () {
    utils_1.utils.writeFile('./dist/storage/storage.json', JSON.stringify(tables, null, 4));
};
exports.Subscribed_services = {
    /*
    ...
    getData: function (className) {
        if (!tables[className]) {
            throw new Error('No ' + className + ' available');
        }
     ...
     */
    iterate: function (className, callback) {
